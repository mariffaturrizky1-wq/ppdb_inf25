...
--
-- Host: localhost:3306
-- Generation Time: Jan 16, 2026 at 06:58 AM
...
(1, 'IPA', 'Cocok untuk yang suka sains, matematika, eksperimen, dan analisis logis.', '2026-01-13 14:07:57'),
(2, 'IPS', 'Cocok untuk yang suka ekonomi, sosial, diskusi, dan komunikasi.', '2026-01-13 14:07:57'),
(3, 'Bahasa', 'Cocok untuk yang suka bahasa asing, sastra, budaya, dan kreativitas verbal.', '2026-01-13 14:07:57');
...
CREATE TABLE `quiz_answers` (
  ...
  `ipa` int NOT NULL DEFAULT '0',
  `ips` int NOT NULL DEFAULT '0',
  `bahasa` int NOT NULL DEFAULT '0',
...
INSERT INTO `quiz_answers` (`id`, `question_id`, `answer`, `ipa`, `ips`, `bahasa`, `sort_order`, `created_at`) VALUES
(1, 1, 'Menganalisis masalah dan mencari solusi logis', 3, 1, 0, 1, '2026-01-13 14:07:57'),
(2, 1, 'Diskusi, debat ringan, dan memahami fenomena sosial', 0, 3, 1, 2, '2026-01-13 14:07:57'),
(3, 1, 'Menulis, membaca cerita, atau belajar bahasa baru', 0, 1, 3, 3, '2026-01-13 14:07:57'),
(4, 1, 'Suka campuran, tergantung mood', 1, 1, 1, 4, '2026-01-13 14:07:57'),
(5, 2, 'Matematika / Fisika / Kimia / Biologi', 3, 0, 0, 1, '2026-01-13 14:07:57'),
(6, 2, 'Ekonomi / Sosiologi / Geografi / Sejarah', 0, 3, 0, 2, '2026-01-13 14:07:57'),
(7, 2, 'Bahasa Indonesia / Bahasa Inggris / Bahasa asing / Sastra', 0, 0, 3, 3, '2026-01-13 14:07:57'),
(8, 2, 'Saya suka beberapa sekaligus', 1, 1, 1, 4, '2026-01-13 14:07:57'),
(9, 3, 'Bikin langkah-langkah, rapi, dan fokus ke data', 3, 1, 0, 1, '2026-01-13 14:07:57'),
(10, 3, 'Mencari sudut pandang, contoh kasus, dan argumen', 0, 3, 1, 2, '2026-01-13 14:07:57'),
(11, 3, 'Merangkai kata, membuat narasi, dan memperindah tulisan', 0, 1, 3, 3, '2026-01-13 14:07:57'),
(12, 3, 'Campur, yang penting selesai', 1, 1, 1, 4, '2026-01-13 14:07:57'),
(13, 4, 'Teknologi, sains, fakta unik, dan eksperimen', 3, 0, 0, 1, '2026-01-13 14:07:57'),
(14, 4, 'Isu sosial, ekonomi, tren masyarakat, dan sejarah', 0, 3, 0, 2, '2026-01-13 14:07:57'),
(15, 4, 'Film, buku, budaya, bahasa, dan storytelling', 0, 0, 3, 3, '2026-01-13 14:07:57'),
(16, 4, 'Apa saja asal menarik', 1, 1, 1, 4, '2026-01-13 14:07:57'),
(17, 5, 'Membuat mini-riset / percobaan / analisis angka', 3, 1, 0, 1, '2026-01-13 14:07:57'),
(18, 5, 'Membuat presentasi isu sosial/ekonomi + solusi', 0, 3, 1, 2, '2026-01-13 14:07:57'),
(19, 5, 'Menulis cerita/puisi, review, atau konten kreatif bahasa', 0, 1, 3, 3, '2026-01-13 14:07:57'),
(20, 5, 'Proyek gabungan (sedikit semuanya)', 1, 1, 1, 4, '2026-01-13 14:07:57');
...
INSERT INTO `quiz_questions` (`id`, `question`, `hint`, `is_active`, `sort_order`, `created_at`) VALUES
(1, 'Kalau belajar, kamu paling menikmati aktivitas yang seperti apa?', 'Pilih yang paling menggambarkan kamu', 1, 1, '2026-01-13 14:07:57'),
(2, 'Pelajaran mana yang paling kamu tunggu-tunggu?', 'Jujur sesuai minat ya', 1, 2, '2026-01-13 14:07:57'),
(3, 'Saat mengerjakan tugas, gaya kamu biasanya…', 'Kebiasaan sehari-hari', 1, 3, '2026-01-13 14:07:57'),
(4, 'Topik obrolan yang paling bikin kamu semangat adalah…', 'Yang bikin kamu betah ngobrol', 1, 4, '2026-01-13 14:07:57'),
(5, 'Kalau diberi proyek bebas, kamu cenderung memilih…', 'Pilih yang paling kamu suka', 1, 5, '2026-01-13 14:07:57');
...
CREATE TABLE `quiz_results` (
  ...
  `ipa_score` int NOT NULL DEFAULT '0',
  `ips_score` int NOT NULL DEFAULT '0',
  `bahasa_score` int NOT NULL DEFAULT '0',
